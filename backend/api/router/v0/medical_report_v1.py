...
from api.repository.generation_registry import extract_medical_report_v1
...
async def extract_medical_report(
  ...
  try:
      ...
      return await extract_medical_report_v1(request,transcript_id,db,api_key_record)
